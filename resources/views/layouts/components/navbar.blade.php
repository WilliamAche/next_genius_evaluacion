                ...
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="To-do"><i class="ficon feather icon-check-square"></i></a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Chat"><i class="ficon feather icon-message-square"></i></a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Email"><i class="ficon feather icon-mail"></i></a>
                        </li>
                        <li class="nav-item d-none d-lg-block">
                            <a class="nav-link" href="#" data-toggle="tooltip" data-placement="top" title="Calendario"><i class="ficon feather icon-calendar"></i></a>
                        </li>
                     </ul>
                     ...
                     <ul class="nav navbar-nav">
                         <li class="nav-item d-none d-lg-block">
                             ...
                             <div class="bookmark-input search-input">
                                 ...
                                 <input class="form-control input" type="text" placeholder="Explorador..." tabindex="0" data-search="template-list">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="nav-item nav-search">
                        ...
                        <div class="search-input">
                            ...
                            <input class="input" type="text" placeholder="Buscador..." tabindex="-1" data-search="template-list">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                @if (Auth::user()->status == 0 && Auth::user()->admin == 0)
                                    <span class="user-status"><i class="fa fa-circle font-small-3 text-danger"></i>Normal</span>
                                @elseif (Auth::user()->status == 1 && Auth::user()->admin == 1)
                                    <span class="user-status"><i class="fa fa-circle font-small-3 text-success"></i>Administrador</span>
                                @endif
                             </div>
                             @if (Auth::user()->photo == NULL)
                                <span>
                                    <img class="round" src="https://ui-avatars.com/api/?background=random&name={{ Auth::user()->name }}" alt="avatar" height="40" width="40">
                                </span>
                             @else
                                <span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('profile') }}"><i class="feather icon-user"></i> Perfil</a>
                            ...
                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i class="feather icon-power"></i> Salir
                            </a>
