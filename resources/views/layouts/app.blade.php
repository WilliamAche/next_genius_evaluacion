    ...
    <footer class="footer footer-static footer-dark navbar-shadow">
        <p class="clearfix blue-grey lighten-2 mb-0">
            <span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021
                <a class="text-bold-800 grey darken-2" href="#">Next Genius,</a>All rights Reserved
            </span>
                
            <span class="float-md-right d-none d-md-block">Hecho a mano y con<i class="feather icon-heart pink"></i></span>
