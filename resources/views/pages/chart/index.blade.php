        ...
        <div class="card bg-analytics text-white">
            <div class="card-content">
                <div class="card-body text-center">
                    <img src="{{ asset('img/template/elements/decore-left.png') }}" class="img-left" alt="card-img-left">
                    <img src="{{  asset('img/template/elements/decore-right.png') }}" class="img-right" alt="card-img-right">
