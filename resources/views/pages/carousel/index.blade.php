                    ...
                    <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="img-fluid" src="{{ asset('img/template/slider/01.jpg') }}" alt="First slide">
                            ...
                            <div class="carousel-item">
                                <img class="img-fluid" src="{{ asset('img/template/slider/02.jpg') }}"
                                    alt="Second slide">
                                <div class="carousel-caption">
                            ...
                            <div class="carousel-item">
                                <img class="img-fluid" src="{{ asset('img/template/slider/03.jpg') }}" alt="Third slide">
                                <div class="carousel-caption">
            ...
            <div class="card-content">
                <div class="card-body">
                    <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="img-fluid" src="{{ asset('img/template/slider/04.jpg') }}" alt="First slide">
                                <div class="carousel-caption">
                                    <h3>First Slide Label</h3>
                                    <p>Donut jujubes I love topping I love sweet. Jujubes I love brownie gummi bears I
                                    love donut sweet chocolate. Tart chocolate marshmallow.Tart carrot cake muffin.</p>
                            ...
                            <div class="carousel-item">
                                <img class="img-fluid" src="{{ asset('img/template/slider/05.jpg') }}"
                                    alt="Second slide">
                                <div class="carousel-caption">
                                    <h3>Second Slide Label</h3>
                                    <p>Tart macaroon marzipan I love soufflé apple pie wafer. Chocolate bar jelly
                            ...
                            <div class="carousel-item">
                                <img class="img-fluid" src="{{ asset('img/template/slider/06.jpg') }}" alt="Third slide">
                                <div class="carousel-caption">
                                    <h3>Third Slide Label</h3>
                                    <p>Pudding sweet pie gummies. Chocolate bar sweet tiramisu cheesecake chocolate
                                    cotton candy pastry muffin. Marshmallow cake powder icing.</p>
