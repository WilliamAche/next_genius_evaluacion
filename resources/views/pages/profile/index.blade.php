        ...
        <div class="col-12">
            <div class="profile-header mb-2">
                <div class="relative">
                    ...
                    @else
                    <div class="profile-img-container d-flex align-items-center justify-content-between">
                        <img src="{{ asset('storage/photo-profile/'.Auth::user()->photo) }}"
                            class="rounded-circle img-border box-shadow-1" alt="Card image">
                    </div>
                    @endif
                </div>
                    ...
                    <form action="{{ route('profile.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-1">
                                ...
                                <div class="media">
                                    <div class="custom-file">
                                        <label class="custom-file-label" for="photo"><b>(Solo JPG o PNG.
                            ...
                            <div class="mt-1">
                                ...
                                <div class="media">
                                    <div class="custom-file">
                                        <label class="custom-file-label" for="banner"><b>(Solo JPG o PNG.
                                                Tamaño máximo de 1mb)</b></label>
                                        <input type="file" id="banner" class="custom-file-input" name="banner"
