        ...
        <div class="card bg-authentication rounded-0 mb-0">
            <div class="row m-0">
                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                    <img src="{{ asset('img/next-genius/logotipo.png') }}" alt="branding logo">
                </div>
                            ...
                            <div class="card-body pt-1">
                                ...
                                @csrf
                                    ...
                                    <div class="float-md-left d-block mb-1">
                                        <a href="{{ route('register') }}" class="btn btn-outline-primary btn-block px-75">Registrarme</a>
                                    </div>
                                    <div class="float-md-right d-block mb-1">
                                        <button type="submit" class="btn btn-primary btn-block px-75">Iniciar sesion</button>
                                    </div>
                                </form>
                            </div>
                        </div>
