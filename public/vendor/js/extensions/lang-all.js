    ...
    return function (e) {
        ...
        ! function (e, a) {
            ...
            function t(e, t, n, r) {
                ...
                switch (n) {
                    ...
                    case "MM":
                        return a(e) ? t ? s + "mÃ¡nuÃ°ir" : s + (r ? "mÃ¡nuÃ°i" : "mÃ¡nuÃ°um") : t ? s + "mÃ¡nuÃ°ur" : s + (r ? "mÃ¡nuÃ°" : "mÃ¡nuÃ°i");
                    case "y":
                        return t || r ? "Ã¡r" : "Ã¡ri";
                    case "yy":
        ...
        ! function (e, a) {
            ...
            function n(e, a) {
                ...
                return e ? t[/(\[[Ð’Ð²Ð£Ñƒ]\]) ?dddd/.test(a) ? "accusative" : /\[?(?:Ð¼Ð¸Ð½ÑƒÐ»Ð¾Ñ—|Ð½Ð°ÑÑ‚ÑƒÐ¿Ð½Ð¾Ñ—)? ?\] ?dddd/.test(a) ? "genitive" : "nominative"][e.day()] : t.nominative
            }
